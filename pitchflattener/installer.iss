...
[Files]
Source: "build\PitchFlattener_artefacts\Release\VST3\SammyJs Pitch Flattener.vst3\*"; DestDir: "{app}\SammyJs Pitch Flattener.vst3"; Flags: ignoreversion recursesubdirs createallsubdirs
